    ...
    
{
    ...
    javaDate = new Date(listOfrequests[i].replydate);
    
    cell4.innerHTML = String(javaDate.getFullYear()) + "-" + String(javaDate.getMonth()+1) + "-" + String(javaDate.getDate()) ;
        
    cell5.innerHTML = " <form action='/giveAbook' method='POST'> <input type='text' class='username' name='username' value=" + sessionStorage.getItem("username") + " style='display:none'> <input type='text' class='tempPassword' name='temppassword' value=" + sessionStorage.getItem("tempPassword") + " style='display:none'> <input type='text' class='bookTitle' name='booktitle' value='" + listOfrequests[i].title + "' style='display:none'> <input type='text' class='clientName' name='clientname' value='"+ listOfrequests[i].username + "' + style='display:none'> <input type='submit' class='giveButton' value='Give'> </form> " ;
